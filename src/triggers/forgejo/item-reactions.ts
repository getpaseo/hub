...
export type ForgejoItemReactionContent = "eyes" | "+1" | "-1";

export interface ForgejoItemReactionSubject {
  kind: "issue" | "pull_request";
  id: number;
}

export interface ForgejoItemReactionClient {
  create(input: {
    connectionId: string;
    owner: string;
    repo: string;
    subject: ForgejoItemReactionSubject;
    content: ForgejoItemReactionContent;
  }): Promise<void>;
}

export function createForgejoItemReactionClient(options: {
