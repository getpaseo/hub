  ...
  private async startHub(): Promise<ManagedChild> {
    return startChild({
      ...
      env: {
        ...
        PASEO_HUB_COMPLETION_TOKEN_SECRET: "hub-e2e-completion-secret",
        PASEO_HUB_PUBLIC_URL: this.requireProxy().origin,
        BETTER_AUTH_URL: this.requireProxy().origin,
        BETTER_AUTH_SECRET: "hub-e2e-browser-auth-secret-at-least-32-characters",
